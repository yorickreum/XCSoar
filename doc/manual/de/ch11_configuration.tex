...
{\bf Manueller UTC-Offset}: Es wird der unten von Hand eingegebene Offset benutzt. Er muss zu jeder Zeitumstellung korrigiert werden.
...
\item[\textit{Manueller UTC-Offset}]  {\bf -13 ..+14h}: In diesem Feld wird der Offset der Lokalzeit zur UTC-Zeit eingegeben. Das Feld ist nur bearbeitbar, wenn als Quelle der Lokalzeit ''Manueller UTC-Offset`` gewählt ist. Die Differenz kann im 15-Minuten-Intervall eingegeben werden.
